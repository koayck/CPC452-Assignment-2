...
#pragma warning restore 0649
		...
		//VR Implementation — re-parents the console to the active XR camera (Camera.main)
		public GameObject ovrCameraRig; // kept for Inspector compat; unused at runtime
